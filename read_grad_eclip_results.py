...
def main():
    ...
    data = evaluator.read_results('results_grad_eclip_compatible/', Result.SUCCESS.name)
    # print(data[data['state'] == 2].index.tolist())
    # print(data[data['scene'] == 'hm3d/val/00880-Nfvxx8J5NCo/Nfvxx8H5NCo.basis.glb'][data['state'] == 5].index.tolist())
